      ...
      <body>
        <div className="flex flex-col overflow-hidden" style={{ height: "100dvh" }}>
          ...
          <main className="flex min-h-0 flex-1 flex-col overflow-y-auto">
            {children}
            <footer className="shrink-0 border-t border-border-subtle px-6 py-4 flex flex-col items-center gap-2">
              <div className="flex items-center gap-4">
                <a
                  href="https://www.instagram.com/rushmore.cards"
                  target="_blank"
                ...
                <a
                  href="https://www.tiktok.com/@rushmore.card"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="TikTok"
                  className="text-text-tertiary hover:text-text transition-colors"
