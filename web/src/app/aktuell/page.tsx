...
const CATEGORIES: CategoryPill[] = [
  ...
  { label: "All-NBA 1", path: "all-nba/1", params: { limit: 15 }, cardSubtitle: "ALL-NBA FIRST TEAM" },
  { label: "All-NBA 2", path: "all-nba/2", params: { limit: 15 }, cardSubtitle: "ALL-NBA SECOND TEAM" },
  { label: "All-NBA 3", path: "all-nba/3", params: { limit: 15 }, cardSubtitle: "ALL-NBA THIRD TEAM" },
];
